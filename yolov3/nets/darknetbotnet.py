...
class DarkNet(nn.Module):
    def __init__(self, block,layers,resolution=(224, 224), heads=4):
        ...
        self.layer5 = self._make_layer(block,1024,layers[4],stride=2,heads=heads,mhsa=True)
...
#def darknet53( resolution=(224, 224), heads=4):
    #model = darknet53(Bottleneck,[1, 2, 8, 8, 4],resolution=resolution, heads=heads)   #列表中为残差块使用次数
    # if pretrained:
...
# def darknet53(resolution=(224, 224), heads=4):
#     return DarkNet(Bottleneck,[1,2,8,8,4],resolution=resolution,heads=heads)


# def main():
#     x = torch.randn([2, 3, 224, 224])
#     model = darknet53(resolution=(224,224), heads=4)
#     print(model(x))
