...
class YoloBody(nn.Module):
    def __init__(self, anchor, num_classes):
        ...
        out_filters = self.backbone.layers_out_filters   #self.layers_out_filters = [64, 128, 256, 512, 1024]

        #------------------------------------------------------------------------#
        #   计算yolo_head的输出通道数，对于voc数据集而言
        #   final_out_filter0 = final_out_filter1 = final_out_filter2 = 75
        #------------------------------------------------------------------------#
        final_out_filter0 = len(anchor[0]) * (5 + num_classes)     #anchor[0]=3    final_out_filter0=75
    ...
    def forward(self, x):
        def _branch(last_layer, layer_in):    #分开卷积层结果
